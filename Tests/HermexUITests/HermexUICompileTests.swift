...
final class HermexUICompileTests: XCTestCase {
    ...
    func testSharedLayoutTokensMatchIOSContracts() {
        ...
        XCTAssertEqual(HermexLayoutContract.topChromeCircleSize, 44)
        ...
        XCTAssertEqual(HermexLayoutContract.chatTopBarHeight, 62)
    ...
    func testPlatformHandledUIEventsStayOutOfSharedStoreActions() {
        ...
        XCTAssertEqual(HermexUIEvent.updateAppTheme("dark").appAction, .updateAppTheme("dark"))
        XCTAssertEqual(HermexUIEvent.updateHapticsEnabled(false).appAction, .updateHapticsEnabled(false))
        XCTAssertEqual(HermexUIEvent.updateGlassEnabled(false).appAction, .updateGlassEnabled(false))
        XCTAssertEqual(HermexUIEvent.updateNotificationsEnabled(true).appAction, .updateNotificationsEnabled(true))
        ...
        XCTAssertEqual(HermexUIEvent.openDefaultModelPicker.appAction, .openDefaultModelPicker)
