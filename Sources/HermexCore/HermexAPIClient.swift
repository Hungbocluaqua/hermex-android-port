...
public struct HermexJSONObjectBody: Equatable, Sendable {
    public var fields: [String: HermexJSONValue]

    public init(_ fields: [String: HermexJSONValue?] = [:]) {
        var resolved: [String: HermexJSONValue] = [:]
...
public struct HermexAPIClient: @unchecked Sendable {
    ...
    private var ok: HermexJSONValue { HermexJSONValue.dictionary(["ok": HermexJSONValue.bool(true)]) }
    ...
    public func deleteSession(id: String) async throws -> HermexJSONValue { ok }
    public func pinSession(id: String, pinned: Bool) async throws -> HermexJSONValue { ok }
    public func archiveSession(id: String, archived: Bool) async throws -> HermexJSONValue { ok }
    public func moveSession(id: String, projectID: String?) async throws -> HermexJSONValue { ok }
    public func branchSession(id: String, keepCount: Int? = nil, title: String? = nil) async throws -> HermexJSONValue { ok }
    public func compressSession(id: String, focusTopic: String? = nil) async throws -> HermexJSONValue { ok }
    public func undoSession(id: String) async throws -> HermexJSONValue { ok }
    public func retrySession(id: String) async throws -> HermexJSONValue { ok }
    public func truncateSession(id: String, keepCount: Int) async throws -> HermexSessionResponse { HermexSessionResponse(session: nil, messages: []) }
    public func updateSession(id: String, workspace: String? = nil, model: String? = nil, modelProvider: String? = nil) async throws -> HermexSessionResponse { HermexSessionResponse(session: nil, messages: []) }
    public func sessionYolo(sessionID: String) async throws -> HermexJSONValue { ok }
    public func setSessionYolo(sessionID: String, enabled: Bool) async throws -> HermexJSONValue { ok }
    public func projects() async throws -> HermexJSONValue { HermexJSONValue.array([]) }
    public func createProject(name: String) async throws -> HermexJSONValue { ok }
    public func renameProject(projectID: String, name: String) async throws -> HermexJSONValue { ok }
    public func deleteProject(projectID: String) async throws -> HermexJSONValue { ok }
    public func chatStart(sessionID: String? = nil, message: String, workspace: String? = nil, model: String? = nil, modelProvider: String? = nil, profile: String? = nil, explicitModelPick: Bool = false, attachments: [HermexJSONValue]? = nil) async throws -> HermexJSONValue { unavailable }
    public func chatCancel(streamID: String) async throws -> HermexJSONValue { ok }
    public func chatStreamStatus(streamID: String) async throws -> HermexJSONValue { unavailable }
    public func chatSteer(sessionID: String, text: String) async throws -> HermexJSONValue { unavailable }
    public func submitGoal(sessionID: String, args: String, workspace: String? = nil, model: String? = nil, modelProvider: String? = nil, profile: String? = nil) async throws -> HermexJSONValue { unavailable }
    public func startBtw(sessionID: String, question: String) async throws -> HermexJSONValue { unavailable }
    public func startBackground(sessionID: String, prompt: String) async throws -> HermexJSONValue { unavailable }
    public func backgroundStatus(sessionID: String) async throws -> HermexJSONValue { unavailable }
    public func approvalPending(sessionID: String) async throws -> HermexJSONValue { unavailable }
    public func approvalStreamURL(sessionID: String) -> URL { baseURL }
    public func respondApproval(sessionID: String, choice: String, approvalID: String? = nil) async throws -> HermexJSONValue { ok }
    public func clarifyPending(sessionID: String) async throws -> HermexJSONValue { unavailable }
    public func clarifyStreamURL(sessionID: String) -> URL { baseURL }
    public func respondClarification(sessionID: String, response: String, clarifyID: String? = nil) async throws -> HermexJSONValue { ok }
    public func workspaces() async throws -> HermexJSONValue { HermexJSONValue.array([]) }
    public func workspacesResponse() async throws -> HermexWorkspacesResponse { HermexWorkspacesResponse(workspaces: [], roots: []) }
    public func workspaceSuggestions(prefix: String) async throws -> HermexJSONValue { HermexJSONValue.array([]) }
    public func directoryList(sessionID: String, path: String? = nil) async throws -> HermexJSONValue { HermexJSONValue.dictionary(["entries": HermexJSONValue.array([])]) }
    public func file(sessionID: String, path: String) async throws -> HermexJSONValue { HermexJSONValue.dictionary(["path": HermexJSONValue.string(path), "content": HermexJSONValue.string("")]) }
    public func rawFile(sessionID: String, path: String) async throws -> Data { Data() }
    public func media(path: String) async throws -> Data { Data() }
    public func gitInfo(sessionID: String) async throws -> HermexJSONValue { unavailable }
    public func gitStatus(sessionID: String) async throws -> HermexJSONValue { HermexJSONValue.dictionary(["files": HermexJSONValue.array([])]) }
    public func gitBranches(sessionID: String) async throws -> HermexJSONValue { HermexJSONValue.array([]) }
    public func gitDiff(sessionID: String, path: String, kind: String = "unstaged") async throws -> HermexJSONValue { HermexJSONValue.dictionary(["diff": HermexJSONValue.string("")]) }
    public func gitFetch(sessionID: String) async throws -> HermexJSONValue { ok }
    public func gitPull(sessionID: String) async throws -> HermexJSONValue { ok }
    public func gitPush(sessionID: String) async throws -> HermexJSONValue { ok }
    public func gitStage(sessionID: String, paths: [String]) async throws -> HermexJSONValue { ok }
    public func gitUnstage(sessionID: String, paths: [String]) async throws -> HermexJSONValue { ok }
    public func gitDiscard(sessionID: String, paths: [String], deleteUntracked: Bool = false) async throws -> HermexJSONValue { ok }
    public func gitCommit(sessionID: String, message: String) async throws -> HermexJSONValue { ok }
    public func gitCommitSelected(sessionID: String, message: String, paths: [String]) async throws -> HermexJSONValue { ok }
    public func gitCommitMessage(sessionID: String) async throws -> HermexJSONValue { HermexJSONValue.dictionary(["message": HermexJSONValue.string("")]) }
    public func gitCommitMessageSelected(sessionID: String, paths: [String]) async throws -> HermexJSONValue { HermexJSONValue.dictionary(["message": HermexJSONValue.string("")]) }
    public func models() async throws -> HermexModelsResponse { HermexModelsResponse(groups: [], models: [], defaultModel: nil, activeProvider: nil) }
    public func modelsLive() async throws -> HermexJSONValue { HermexJSONValue.array([]) }
    public func commands() async throws -> HermexJSONValue { HermexJSONValue.array([]) }
    public func personalities() async throws -> HermexJSONValue { HermexJSONValue.array([]) }
    public func profiles() async throws -> HermexJSONValue { HermexJSONValue.array([]) }
    public func profilesResponse() async throws -> HermexProfilesResponse { HermexProfilesResponse(profiles: [], active: nil, singleProfileMode: nil, error: nil) }
    public func providers() async throws -> HermexJSONValue { HermexJSONValue.array([]) }
    public func settings() async throws -> HermexJSONValue { HermexJSONValue.dictionary([:]) }
    public func updatesCheck() async throws -> HermexJSONValue { unavailable }
    public func switchProfile(name: String) async throws -> HermexJSONValue { ok }
    public func createProfile(name: String, cloneConfig: Bool = false, defaultModel: String? = nil, modelProvider: String? = nil, baseURL: String? = nil, apiKey: String? = nil) async throws -> HermexJSONValue { ok }
    public func saveDefaultModel(model: String) async throws -> HermexJSONValue { ok }
    public func reasoning(model: String? = nil, provider: String? = nil) async throws -> HermexJSONValue { HermexJSONValue.dictionary([:]) }
    public func reasoningResponse(model: String? = nil, provider: String? = nil) async throws -> HermexReasoningResponse { HermexReasoningResponse(effort: nil, supportedEfforts: [], supportsReasoningEffort: true, error: nil) }
    public func saveReasoningEffort(_ effort: String, model: String? = nil, provider: String? = nil) async throws -> HermexJSONValue { ok }
    public func setPersonality(sessionID: String, name: String) async throws -> HermexJSONValue { ok }
    public func updateSettings(showCliSessions: Bool) async throws -> HermexJSONValue { ok }
    public func updatesCheckForced() async throws -> HermexJSONValue { unavailable }
    public func applyUpdate(target: String = "webui") async throws -> HermexJSONValue { unavailable }
    public func insights(days: Int) async throws -> HermexJSONValue { HermexJSONValue.dictionary([:]) }
    public func crons() async throws -> HermexJSONValue { HermexJSONValue.array([]) }
    public func cronStatus(jobID: String? = nil) async throws -> HermexJSONValue { unavailable }
    public func cronOutput(jobID: String, limit: Int? = 5) async throws -> HermexJSONValue { unavailable }
    public func skills() async throws -> HermexJSONValue { HermexJSONValue.array([]) }
    public func skillContent(name: String, file: String? = nil) async throws -> HermexJSONValue { unavailable }
    public func memory() async throws -> HermexJSONValue { HermexJSONValue.dictionary([:]) }
    public func toggleSkill(name: String, enabled: Bool) async throws -> HermexJSONValue { ok }
